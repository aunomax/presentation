...
\begin{lemma}[\blue{Winkler, Djie (2010) NA}]\label{local existence and uniqueness}
...
\item scaling critical norm $L^{\frac{n}{2}\alpha}$: $\|u_0\|_{L^{\frac{n}{2}\alpha}}<\epsilon$ $\Rightarrow$ $\|u\|_{L^\infty}<C$. \blue{Cao (2015) DCDS}
\end{itemize}
\end{block}
\end{frame} 
